...
@Repository
public interface SkillOfferRepository extends CrudRepository<SkillOffer, UUID> {

    @Query(nativeQuery = true, value = "INSERT INTO skill_offer (skill_id, recommendation_id) VALUES (?1, ?2) returning id")
    Long create(UUID skillId, UUID recommendationId);
    ...
    @Query(nativeQuery = true, value = """
            ...
            """)
    int countAllOffersOfSkill(UUID skillId, UUID userId);
    ...
    @Query(value = """
            ...
            """)
    List<SkillOffer> findAllOffersOfSkill(UUID skillId, UUID userId);
}